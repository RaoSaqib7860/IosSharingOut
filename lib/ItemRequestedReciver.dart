...
class ItemRequestedReciver extends StatefulWidget {
  static var provider;
  ItemRequestedReciver({Key key, this.wich}) : super(key: key);
  final String wich;
  @override
  _ItemRequestedReciverState createState() => _ItemRequestedReciverState();
}

class _ItemRequestedReciverState extends State<ItemRequestedReciver> {
  List list = [1, 2, 3, 4, 5];

  @override
  void initState() {
    final BlockItemRequestedReciver _provider =
        Provider.of<BlockItemRequestedReciver>(context, listen: false);
    apiCalling(_provider);
    super.initState();
  }

  apiCalling(BlockItemRequestedReciver provider) async {
    await ApiUtilsClass.itemRequestedReciverData(provider);
  }
  ...
  Widget build(BuildContext context) {
    final BlockItemRequestedReciver _provider =
        Provider.of<BlockItemRequestedReciver>(context);
    ItemRequestedReciver.provider = _provider;
                                      ...
                                      ? Align(
                                          ...
                                          child: Container(
                                            ...
                                            child: InkWell(
                                              ...
                                              child: Text(
                                                'Delivered by : ${_provider.searchList[i]['giver_name']}',
                                                style: TextStyle(
  ...
  openDailog(
      int index, BlockItemRequestedReciver provider, orderid, String name) {
    var height = MediaQuery.of(context).size.height;
    var width = MediaQuery.of(context).size.width;
    int value = 0;
    showDialog(
                      ...
                      child: InkWell(
                        onTap: () {
                          if (value > 0) {
                            ...
                            ApiUtilsClass.addReciverRating(
